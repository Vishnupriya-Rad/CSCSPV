 ...
 */
 ...
 class theme_lambda_core_renderer extends core_renderer {
    ...
    public function lambda_course_group_ids() {
        ...
        $substring = "/report/grader/index.php";
        if (strpos($currentUrl, $substring) !== false) {
            $context = context_course::instance($PAGE->course->id);
            //Sichtbarkeit!!! Ändern zu dropdown-menu
            ...
            $list .= '<a class="d-flex" href="/grade/report/grader/index.php?id='.$PAGE->course->id.'&group=0">'.get_string('allparticipants').'</a></li>';
            ...
            foreach ($groups as $group) {
                ...
                $list .= '<a class="d-flex" href="/grade/report/grader/index.php?id='.$PAGE->course->id.'&group='.$group->id.'">'.$group->name.'</a></li>';
            }
            $list .= '</ul></div>';
            return $list;
        } else {
	...
	public function lambda_footer_scripts() {
        ...
        $aria = html_writer::tag($tag, file_get_contents ($upOne . '/javascript/aria.js'));
